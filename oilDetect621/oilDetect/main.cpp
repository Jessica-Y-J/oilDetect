...
int sigma = 2;
int windsize = 7;
int typeOfDetect = 4;//检测，0=长，1=圆,2=金属圆孔，3=本体机图 4=表盘指针式
...
int main()
{
	...
	originalImg = imread("102\\VIcappic-2015-07-08-17-02-01-2180102开关-SF6压力仪表.jpg"); // Read the file
